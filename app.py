...
class ToxicityModel:
    ...
    def train_model(self, epochs=1):
        history = self.model.fit(self.train, epochs=epochs, validation_data=self.val)
...
toxicity_model.train_model(epochs=1)
...
# Make predictions
predictions = toxicity_model.make_predictions('You freaking suck! I am going to hit you.')
print(predictions)
